...
//=====================================================================
	...
	struct parser
	{
		...
		auto debug_print(int spaces = 0) const -> void;

	private:
		auto debug_print_impl(std::set<detail::parser_backend_ptr>& visited, detail::parser_backend_ptr const&, int spaces) const -> void;
